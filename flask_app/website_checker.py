...
def get_crawler():
   LIST_OF_RANDOM_DOMAINS = []
   LIST_OF_SUGGESTED_DOMAINS = []
   ...
   for domain, price in found_domains.items():
      ...
      if govalue >= min_appr_price:
         go_value = {}
         go_value['domain'] = domain
         go_value['price'] = price
         go_value['govalue'] = govalue
         LIST_OF_RANDOM_DOMAINS.append(go_value)
      ...
      for sale in comparable_sales:
         ...
         if sale["price"] >= min_sale_price and sale["year"] >= min_sale_year:
            LIST_OF_SUGGESTED_DOMAINS.append(sale)
   ...
   #    print(domain)
   # print("--------------------------------------------------------")
   return LIST_OF_SUGGESTED_DOMAINS, LIST_OF_RANDOM_DOMAINS

if __name__ == "__main__":
   '''
   For getting list_of_suggested_domains
   '''
   lsd,lrd = get_crawler()
